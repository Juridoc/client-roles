 ...
 * Roles mapper class.
 */
@Injection.Describe({ singleton: true, name: 'roles' })
@Class.Describe()
export class Mapper extends Class.Null {
  ...
  /**
   * Load the role that corresponds to the specified role Id.
   * @param id Role Id.
   * @param fields Fields to be selected.
   * @returns Returns a promise to get the role entity.
   * @throws Throws an error when the role wasn't found.
   */
  @Class.Public()
  ...
  /**
   * List all roles that corresponds to the specified filter.
   * @param query Query filter.
   * @param fields Fields to be selected.
   * @returns Returns a promise to get the role list or undefined when an error occurs.
   */
  @Class.Public()
  ...
  /**
   * Count all roles that corresponds to the specified filter.
   * @param query Query filter.
   * @returns Returns a promise to get the number of roles or undefined when an error occurs.
   */
  @Class.Public()
